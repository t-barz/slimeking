# 📋 Lista de Arquivos de Código - The Slime King

**Pastas Base:** `Assets/Code` + `Assets/External/AssetStore/SlimeMec`  
**Total de Arquivos:** 133 arquivos C# (109 + 24)  
...
### Assets/Code (109 arquivos)

#### Data (2 arquivos)
- Quest: CollectQuestData, ItemReward

#### Debug (1 arquivo)
- CrystalUIDebugger

#### Dialogue (6 arquivos)
- DialogueEvents, DialogueInputHandler, DialogueNPC, DialoguePlayerController, DialogueUI, TypewriterEffect

#### Editor/ExtraTools (29 arquivos)
- Ferramentas de editor, validadores, setup tools, quick config

#### Gameplay (14 arquivos)
- InteractionHandler, NPCs, Props, Quest, Teleport, UI

#### QuestSystem (2 arquivos)
- ItemRewardDrawer, QuestManagerEditor

#### Systems (53 arquivos)
- AI, Camera, Controllers, Core, Data, Debug, Events, Inventory, Managers, QuestSystem, UI, Validators

#### UI (1 arquivo)
- DialogueUIManager

#### Visual (3 arquivos)
- GizmosHelper, OutlineUtility, PolygonGizmosHelper

---

### Assets/External/AssetStore/SlimeMec (24 arquivos)

#### _Scripts/Gameplay (22 arquivos)
- AttackHandler, BounceHandler, BushDestruct, BushShake, CollectableItemData
- DropController, InteractivePointHandler, ItemBuffHandler, ItemCollectable, ItemPickup
- PerformanceSystemsIntegration, PlayerAttributesHandler, PlayerController
- RandomStyle, RockDestruct, ScreenEffectsManager, SelfDestruct
- SetupVisualEnvironment, SpecialMovementPoint
- WindController, WindEmulator, WindManager

#### _Scripts/Visual (1 arquivo)
- OutlineController
