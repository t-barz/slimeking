...
namespace SlimeKing.Editor
{
    ...
    public class NPCQuickConfig : EditorWindow
    {
        ...
        // [MenuItem("QuickWins/NPC Quick Config (Use Extra Tools)")]
        ...
        private void LoadTemplate(int templateIndex)
        {
            ...
            {
                case 1: // Cervo-Broto
                    templatePath = "Assets/Data/QuickWins/Templates/NPCTemplates/CervoBrotoTemplate.asset";
                    break;
                case 2: // Esquilo Coletor
                    templatePath = "Assets/Data/QuickWins/Templates/NPCTemplates/EsquiloColetorTemplate.asset";
                    break;
                case 3: // Abelha Cristalina
                    templatePath = "Assets/Data/QuickWins/Templates/NPCTemplates/AbelhaCristalineTemplate.asset";
                    break;
            }
