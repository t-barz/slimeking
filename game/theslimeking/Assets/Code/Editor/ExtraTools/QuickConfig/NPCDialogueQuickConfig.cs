...
namespace ExtraTools.Editor
{
    ...
    public static class NPCDialogueQuickConfig
    {
        ...
        [MenuItem("GameObject/Extra Tools/Configure as Dialogue NPC", false, 10)]
        ...
        /// </summary>
        [MenuItem("GameObject/Extra Tools/Configure as Dialogue NPC", true)]
        ...
        [MenuItem("GameObject/Extra Tools/Show Dialogue NPC Info", false, 11)]
        ...
        [MenuItem("GameObject/Extra Tools/Show Dialogue NPC Info", true)]
