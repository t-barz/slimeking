...
public class PlayerController : MonoBehaviour
{
    ...
    private void OnInteractInput(InputAction.CallbackContext context)
    {
        ...
        {
            // No interaction handler available
        }
    ...
    private IEnumerator PerformSpecialMovement(SpecialMovementPoint movementPoint)
    {
        ...
        try
        {
            ...
            float elapsedTime = 0f;// Loop de movimento - executa até completar (não pode ser cancelado)
    ...
    private void TriggerSpecialMovementAnimation(SpecialMovementPoint.MovementType movementType)
    {
        ...
        switch (movementType)
        {
            case SpecialMovementPoint.MovementType.Jump:
                _animator.SetTrigger(JumpTrigger);PlayJumpSound();
                break;

            case SpecialMovementPoint.MovementType.Shrink:
                _animator.SetTrigger(ShrinkTrigger);PlaySlideSound();
                break;
    ...
    private IEnumerator PerformAttack()
    {
        ...
        AttackHandler attackHandler = attackInstance?.GetComponent<AttackHandler>();
    ...
    private AttackDirection GetAttackDirection()
    {
        switch (_currentVisualDirection)
        {
            ...
            case VisualDirection.Side:
                ...
                return _facingRight ? AttackDirection.East : AttackDirection.West;
