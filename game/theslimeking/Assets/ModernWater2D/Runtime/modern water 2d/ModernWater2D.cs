...
namespace Water2D
{
    ...
    public class ModernWater2D : MonoBehaviour
    {
        ...
        [HideInInspector]public ObstructorManager obstructorManager
        {
            get
            {
        ...
        [HideInInspector] public SurfaceRenderingManager surfaceRenderer
        {
            get
            {
        ...
        [HideInInspector] public ReflectionsSystem reflectionsManagerPlatformer
        {
            get
            {
                ...
                if (_reflectionsManagerPlatformer == null)
                {
                    ...
                    _reflectionsManagerPlatformer.SetupSystem();
                }
        ...
        public ReflectionsSystem reflectionsManagerRayMarch
        {
            get
            {
                ...
                if (_reflectionsManagerRayMarch == null)
                {
                    ...
                    OnReflectionsChanged();
                    _reflectionsManagerRayMarch.SetupSystem();
        ...
        [HideInInspector] public ReflectionsSystem reflectionsManagerTopDown
        {
            get
            {
                if (_reflectionsManagerTopDown == null)
                {
                    ...
                    if (_reflectionsManagerTopDown == null)
                    {
                        ...
                        OnReflectionsChanged();
                        _reflectionsManagerTopDown.SetupSystem();
